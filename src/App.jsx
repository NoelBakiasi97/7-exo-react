...
return (
    <div>
        <h1 className='text-center mx-auto bg-primary text-white w-50'>React JS</h1>
        <div className='container'>
            <Nav exo={exo} setExo={setExo} />
            {exo.map((e, index) => e.etat === 'block' && <div className={'gris mx-auto p-5 mt-4'} key={index}>{e.div}</div>)}
